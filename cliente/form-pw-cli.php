...
$PDO = db_connect();
$sql = "SELECT nome_cli, email_cli, senha_cli FROM tbl_cliente WHERE id_cli = :id";
     ...
     <div class="container" style="margin-bottom:200px;">
      <div class="row" style="margin:50px 0 50px 0;">
          <div class="col-md-12" style="text-align:center;margin:0 0 10px 0;color:#ECB71B;">
            ...
            <h3>PAINEL CLIENTES - ALTERAR SENHA</h3>
          </div>
      ...
      <form action="newpw-cli.php" method="post" name="form1" id="form1">
      <div class="row">

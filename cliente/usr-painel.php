...
/*
          ...
          if($result['tipo_txt'] !== null){ 
            ...
            <a href="https://www.holodroide.com/sistema/uploaders/redirect/'.$NomeTxt.'" target="_blanck">https://www.holodroide.com/sistema/uploaders/redirect/'.$NomeTxt.'</a><br><br>';
          }
          ...
          if($result['tipo_vid'] !== null){ 
            ...
            <a href="https://www.holodroide.com/sistema/uploaders/redirect/'.$NomeTxt.'" target="_blanck">https://www.holodroide.com/sistema/uploaders/redirect/'.$NomeTxt.'</a><br>';
          }
         */
            ?>

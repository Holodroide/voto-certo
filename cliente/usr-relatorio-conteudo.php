                ...
                <div class="col-md-2" style="text-align:left;">
                  ...
                  <?php
                    if ($user1['status_cnt'] == 'N') {
                      ?>
                    <a href="usr-pub-cnt.php?status=S&idcnt=<?php echo $user1['id_cnt'] ?>&idusr=<?php echo $user1['id_usr'] ?>&tipocnt=<?php echo $user1['tipo_cnt'] ?>&textcnt=<?php echo $user1['text_cnt'] ?>" class="btn btn-success" style="width:150px;padding:5px;margin:2px;" role="button">PUBLICAR</a>
                    <!-- br><a href="usr-delete-cnt.php?idcnt=<?php echo $user1['id_cnt'] ?>&idusr=<?php echo $user1['id_usr'] ?>&nomecli=<?php echo $nomecli ?>" class="btn btn-danger"  onclick="return confirm('Tem certeza de que deseja remover?');"  style="width:150px;padding:5px;margin:2px;" role="button">DELETAR</a -->
                    <?php
                    } else {
                      ?>

...
if (empty($name) || empty($email) || empty($cliente)) {
		...
		$PDO = db_connect();
		$sql = "UPDATE tbl_usuario SET id_cli = :idCli, nome_usr = :name, email_usr = :email   WHERE id_usr = :id";
		$stmt = $PDO->prepare($sql);
		$stmt->bindParam(':idCli', $cliente);			

...
<body>
     ...
     <div class="container" style="margin-bottom:200px;">
      ...
      <form action="add-cli.php" method="post"  enctype="multipart/form-data" name="form-cli" id="form-cli">
      <div class="row">
      ...
      <div class="row">
          ...
          <div class="col-md-10" style="text-align:left;padding:5px;">        
            <input type="submit" name="button" id="button"  class="btn btn-warning" value="CADASTRAR" />
          </div>          
      </div>  
      </form>
    </div>

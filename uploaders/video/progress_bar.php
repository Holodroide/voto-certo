...
foreach($findme  as $value) 
	...
	foreach($finished  as $value2) 
	{
		  ...
		  {
			$status="finished";
			echo "<img src=\"images/sucesso.png\" /><br><br>";
	...
	if($found==0)
		...
		**************************************************/
		...
		?>
					...
					<div style=" padding:1px; height:40px; width:224px; background-image:url(images/loading_video_background.png); background-repeat:no-repeat; "><div id="loader_bar" style=" background-image:url(images/front.png); background-repeat:no-repeat; float:left; position:relative; left:2px; top:3px; height:30px; width:<?php echo $procent_extracted; ?>%"></div></div>
		...
		$kw=array();
			...
			echo "<br><br> <b>Um momento enquanto trabalhamos em seu vídeo</b> <br><br>";	
		}
	elseif($found==1) 
	{	echo "<img src=\"images/error.png\" border=\"0\" /><br>";
		...
		echo "<br><a href=\"index.php?finished=true\">"."<img src=\"images/sucesso.png\" border=\"0\" /></a>";

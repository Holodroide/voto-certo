...
<br />
          ...
          if($result['tipo_txt'] !== null){ 
            ...
            <h5><a href="https://www.holodroide.com/sistema/uploaders/redirect/'.$NomeTxt.'" target="_blanck">https://www.holodroide.com/sistema/uploaders/redirect/'.$NomeTxt.'</a></h5><br>';
          }
...
<br />
          ...
          if($user['tipo_vid'] !== null){ 
            ...
            echo '<strong>Vídeo Redirect </strong><br>
            <a href="https://www.holodroide.com/sistema/uploaders/redirect/'.$NomeTxt.'" target="_blanck">https://www.holodroide.com/sistema/uploaders/redirect/'.$NomeTxt.'</a></h5><br>';
          }

...
$sql_count = "SELECT COUNT(*) AS total FROM tbl_cnt_usr WHERE id_usr = $idusr";
     ...
     <div class="container" style="margin-bottom:200px;">
      ...
      <div class="row">
          <div class="col-md-12" style="text-align:LEFT;margin:50px 0 10px 0;">
              ...
              <h3>ADMIN - LISTAR CONTEÚDO USUÁRIO</h3><br>
      ...
      <div class="row">
          <div class="col-md-12" style="text-align:LEFT;margin:0 0 30px 0;">
              <div style="margin:0 auto;text-align:center; max-width:800px;display: inline">
                  <div style="display: inline">
                      <a href="index.php" class="btn" style="background-color: #ddd;margin:2px;" role="button">HOME</a>           
                  </div>

                  <div class="dropdown" style="display: inline">
                      <button class="btn dropdown-toggle" style="background-color: #ddd;margin:2px;" type="button" data-toggle="dropdown">ADMINISTRADORES
                      <span class="caret"></span></button>
                      <ul class="dropdown-menu">
                        <li><a href="adm-painel.php" class="btn" style="background-color: #ddd;margin:2px;"  role="button">LISTAR</a></li>
                        <li><a href="adm-add-form.php" class="btn" style="background-color: #ddd;margin:2px;" role="button">INSERIR</a></li>
                      </ul>
                  </div>

                  <div class="dropdown" style="display: inline">
                      <button class="btn dropdown-toggle" style="background-color: #ddd;margin:2px;" type="button" data-toggle="dropdown">CLIENTES
                      <span class="caret"></span></button>
                      <ul class="dropdown-menu">
                        <li><a href="cli-painel.php" class="btn" style="background-color: #ddd;margin:2px;"  role="button">LISTAR</a></li>
                        <li><a href="cli-add-form.php" class="btn" style="background-color: #ddd;margin:2px;" role="button">INSERIR</a></li>
                      </ul>
                  </div>

                  <div class="dropdown" style="display: inline">
                      <button class="btn dropdown-toggle" style="background-color: #ddd;margin:2px;" type="button" data-toggle="dropdown">USUÁRIOS
                      <span class="caret"></span></button>
                      <ul class="dropdown-menu">
                        <li><a href="usr-painel.php" class="btn" style="background-color: #ddd;margin:2px;"  role="button">LISTAR</a></li>
                        <li><a href="usr-add-form.php" class="btn" style="background-color: #ddd;margin:2px;" role="button">INSERIR</a></li>
                      </ul>
                  </div>

                  <div style="display: inline">
                      <a href="logout.php" class="btn" style="background-color: #ddd;margin:2px;">LOGOUT</a>  
                  </div>
              </div>
          </div>  
      ...
      <div class="row">
          <div class="col-md-12" style="text-align:left;margin:0 0 30px 0;">
            <strong>USUÁRIO:</strong> <?php echo strtoupper($_GET['nomeusr']) ?><br>
            <?php
            ...
            echo '<strong>CLIENTE: </strong>'.strtoupper($user['nome_cli']).'<br>'; 
            $nomecli = $user['nome_cli'];
            ?>  
      ...
      $sql2 = "SELECT * FROM tbl_usr inner join tbl_cnt_usr on tbl_usr.id_usr = tbl_cnt_usr.id_usr WHERE tbl_usr.id_usr = $idusr AND tbl_cnt_usr.id_usr = $idusr AND tbl_cnt_usr.tipo_cnt = 'img'  ORDER BY tbl_cnt_usr.id_cnt DESC";        
      $stmt = $PDO->prepare($sql2);
      $stmt->execute();
      ...
      $sql3 = "SELECT * FROM tbl_usr inner join tbl_cnt_usr on tbl_usr.id_usr = tbl_cnt_usr.id_usr WHERE tbl_usr.id_usr = $idusr AND tbl_cnt_usr.id_usr = $idusr AND tbl_cnt_usr.tipo_cnt = 'vid'  ORDER BY tbl_cnt_usr.id_cnt DESC";              
